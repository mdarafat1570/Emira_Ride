                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            HeaderText(
                              text: "${MyStrings.earn} ${controller.currencySym}${StringConverter.formatNumber(controller.repo.apiClient.getReferAmount())}",
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      spaceDown(Dimensions.space3),
                      Text(
                        "${MyStrings.referralSubtitle.tr} ${controller.currencySym}${StringConverter.formatNumber(controller.repo.apiClient.getReferAmount())} ${controller.repo.apiClient.getCurrency()} ${MyStrings.firstOrder.tr}",
                          ...
                          Padding(
                            ...
                            child: DottedBorder(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  controller.isLoading ? '${MyStrings.loading.tr}...' : (controller.user.username ?? '').toUpperCase(),
                                  style: regularDefault.copyWith(
                                    color: MyColor.bodyText,
                                    fontSize: Dimensions.fontMedium,
                                  ),
                            ...
                            child: Row(
                              ...
                              children: [
                                MyImageWidget(
                                  ...
                                  height: 40,
                                  radius: 20,
                                  imageUrl: controller.referUsers[index].imageWithPath ?? '',
                                  isProfile: true,
                                ),
                                ...
                                Expanded(
                                  flex: 3,
                                  child: CardColumn(
                                    header: "${controller.referUsers[index].firstname?.removeNull()} ${controller.referUsers[index].lastname}".toTitleCase(),
                                    body: '${controller.referUsers[index].email}',
                                  ),
                                ),
                                Container(
                                  padding: const EdgeInsets.symmetric(
